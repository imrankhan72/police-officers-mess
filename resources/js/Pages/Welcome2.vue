<template>
    <div class="container mx-auto bg-gray-100">
        <header class="inset-x-0 top-0 z-50 bg-white">
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div class="flex lg:flex-1">
                     <a class="flex items-center" href="/en" title="Home" rel="home">
                         <img src="https://www.mppolice.gov.in/sites/default/files/MP-POLICE_0_0.png" alt="Home">
                           <div class="ml-2">
                              <h1 class="text-xl font-bold uppercase">MP Police officers mess</h1>
                           </div>
                     </a>
                </div>
                ...
                <div class="hidden lg:flex lg:gap-x-12">
                    <a v-for="item in navigation" :key="item.name" :href="item.href" class="text-sm font-semibold leading-6 text-yellow-800">{{ item.name }}</a>
                </div>
                <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                    <a href="#" class="text-sm font-semibold leading-6 text-yellow-800">Log in <span aria-hidden="true">&rarr;</span></a>
                </div>
            </nav>
        ...
        <div class="bg-white py-12">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:text-center">
                    <h2 class="text-base font-semibold leading-7 text-indigo-600">Welcome</h2>
                    <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Welcome to Police Officers Mess</p>
...
<!--        Photos-->
       ...
       <section class="container mx-auto max-w-7xl">
           <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-12 lg:px-6 ">
               <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                   <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Photo gallery</h2>
               </div>
           </div>
