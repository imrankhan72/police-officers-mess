                    ...
                    <div class="about" style="margin-top: 4px">
                        ...
                        <div class="list-group">
                            <a href="#" class="list-group-item active">Definitions</a>
                                ...
                                <strong>Member</strong> : All Gazetted Officers (Dy. SP &amp; above) of the Madhya Pradesh Police and those IPS officers borne on Madhya Pradesh Cadre are members. All members are mandatorily required to pay an annual membership fee.
                            </a>
                                                    <a href="#" class="list-group-item">
                                <strong>Hon. Members</strong> : All retired Gazetted officers – (Dy. SP &amp; above) of the Madhya Pradesh Police and retired IPS officers, borne earlier on MP Cadre.
                            </a>
                                                    <a href="#" class="list-group-item">
                                <strong>Non-member</strong> : All serving or retired IPS officers or Gazetted police officers Dy. SP &amp; above of other States or Central Police organizations.
                            </a>
                                                    <a href="#" class="list-group-item">
                                <strong>Guest</strong> : A Guest of a Member / Non Member or Hon. Member.
                            </a>
                                                </div>
                        ...
                        <div class="list-group">
                            <a href="#" class="list-group-item active">Marriages:</a>
                                                        <a href="#" class="list-group-item">
                                    A maximum of 10 rooms at a time can be given to the member of the mess for the marriage for his/her own marriage or the marriage of their own daughter/son.
                                </a>
                                                </div>
