...
<section class="container section-title" data-aos="fade-up" >
    <p id="title"><span>Privacy POLICY
</span></p>
</section>
...
<section class="section ">
            <div class="container pt-5 pb-5">
				...
				<br>
				<h4 >User Of Information Obtained by Police officers mess</h4>
				<p>
				...
				<p>
					Profile information is used by Police officers mess primarily to be presented back to and edited by you when you access the Service and to be presented to other users. In some cases, other users may be able to supplement your profile, including by submitting comments.
				</p>
				<p>
					Police officers mess may use aggregate or anonymous data collected through the Service, including Activity Data, for any purpose. This data may be used by Police officers mess and shared with third parties in any manner.
				</p>
				...
				<br>
				<p>Last revised on August 20th, 2016</p>
