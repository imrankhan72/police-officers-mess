...
<section class="section-sub-banner bg-9">
 ...
 <a class="gallery-item" href="/assets/images/main-gallery/banquet-1.jpg" title="Police Officers' Mess, Bhopal" style="margin-bottom: 20px; flex: 0 0 calc(25% - 20px);">
                            ...
                            <a class="gallery-item" href="/assets/images/main-gallery/billiards.jpg" title="Police Officers' Mess, Bhopal" style="margin-bottom: 20px; flex: 0 0 calc(25% - 20px);">
                             ...
                             <a class="gallery-item" href="/assets/images/main-gallery/lawn-2.jpg" title="Police Officers' Mess, Bhopal" style="margin-bottom: 20px; flex: 0 0 calc(25% - 20px);">
                                <img src="/assets/images/main-gallery/lawn-2.jpg" alt="Police Officers' Mess, Bhopal" style="width: 100%; height: auto;">
                            </a>
                            ...
                            <a class="gallery-item" href="/assets/images/main-gallery/roof-top3.jpg" title="Police Officers' Mess, Bhopal" style="margin-bottom: 20px; flex: 0 0 calc(25% - 20px);">
